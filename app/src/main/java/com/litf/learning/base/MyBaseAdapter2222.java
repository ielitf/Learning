...
public abstract class MyBaseAdapter2222<T> extends BaseAdapter {
    Context mContext;
    List<T> mList;

    public MyBaseAdapter2222() {
        this.mList = new ArrayList();
    }

    public MyBaseAdapter2222(Context context) {
        this.mContext = context;
        this.mList = new ArrayList();
    }

    public MyBaseAdapter2222(Context context, Collection<T> collection) {
        this(context);
